# -*- coding: utf-8 -*-
"""
Created on Thu Apr  6 11:17:56 2023
...
I = {p: m.addVar(lb=LB, ub=UB, vtype=GRB.SEMICONT) for p in Products}
I_prime = {(p,s): m.addVar(lb=LB, ub=UB, vtype=GRB.SEMICONT) for p in Products for s in S}
